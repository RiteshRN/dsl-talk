...
/* package dsl-0.1.0.0 */
#define VERSION_dsl "0.1.0.0"
#define MIN_VERSION_dsl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "dsl-0.1.0.0-HHwIOiy1Cqn9VRUNpv0S0h"

#define CURRENT_PACKAGE_KEY "dsl-0.1.0.0-HHwIOiy1Cqn9VRUNpv0S0h"
